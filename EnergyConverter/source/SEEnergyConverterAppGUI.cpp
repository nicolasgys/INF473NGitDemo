...
SBCContainerUUID SEEnergyConverterAppGUI::getUUID() const { return SBCContainerUUID( "2A223D91-C511-2937-E97B-48CECDD1281F" );}
...
void SEEnergyConverterAppGUI::onLeftChanged(){
    ...
    if(ok){
        ...
        // in the case when the line edit contatinedinvalid characters clear another line edit
