/// \headerfile SEEnergyConverterAppDescriptor.hpp "SEEnergyConverterAppDescriptor.hpp"
#include "SEEnergyConverterAppDescriptor.hpp"
...
SB_ELEMENT_DESCRIPTION("This SAMSON Elements converts some energy quantities.");
SB_ELEMENT_DOCUMENTATION("Resource/Documentation/doc.html");
SB_ELEMENT_VERSION_NUMBER("0.7.0");

SB_ELEMENT_CLASSES_BEGIN;

	SB_ELEMENT_CLASS(SEEnergyConverterApp);
